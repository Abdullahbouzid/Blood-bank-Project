        ...
        <div class="col-lg-9 col-md-12 dataDonation mb-5">
          ...
          <div class="row mt-4">
            ...
            <div class="form-group pt-1 ">
              ...
              <select name="typeBlood" id="" class="form-control" style="text-align: center ;">
              ...
              <select name="typeBlood" id="" class="form-control exception" style="text-align: center;">
                <option value="">--</option>
            ...
            <div class="form-group pt-1">
              ...
              <input type="text" id="" name="nameOfCenter" required class="form-control">
